...
import demons.eureka.server.plugin.event.EurekaInstanceCanceledEvent;
import demons.eureka.server.plugin.event.EurekaInstanceRegisteredEvent;
import demons.eureka.server.plugin.event.EurekaInstanceRenewedEvent;
